/**
 * Reusable fetch wrapper for the whole agent portal. Attaches the JWT,
 ...
 *
 * Token storage is namespaced ("agent_portal_...") so this app's tokens
 * can never collide with the customer portal's tokens even if both were
 * ever served from the same origin.
 */
const Api = (() => {
  const base = window.API_BASE_URL;
  const PREFIX = "agent_portal";
